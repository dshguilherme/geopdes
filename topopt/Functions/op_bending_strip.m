...
function mat = op_bending_strip (ref_sp_u, ref_sp_v, msh, E_coeff, nu_coeff, t_coeff)

   wq = msh.jacdet .* msh.quad_weights;

   [bending_stress, Kappa] = op_KL_bending_strip_stress (ref_sp_u, ref_sp_v, msh, E_coeff .* wq, nu_coeff, t_coeff);
