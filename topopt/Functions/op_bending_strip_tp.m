...
function varargout = op_bending_strip_tp (space_u, space_v, msh, E_coeff, nu_coeff, t_coeff)
  ...
  for iel = 1:msh.nel_dir(1)
    ...
    A = A + op_bending_strip(sp_col_u, sp_col_v, msh_col, E_coeffs, nu_coeffs, t_coeff);
  end
